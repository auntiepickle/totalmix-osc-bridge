            ...
            <div class="card bg-[#1E1E1E] p-6 rounded-2xl" id="card-${name}">
                ...
                <div class="mt-6">
                    ...
                    <div class="h-2 bg-gray-800 rounded-full overflow-hidden">
                        <div id="progress-bar-${name}" class="progress-bar h-full bg-gradient-to-r from-orange-400 to-purple-400 transition-all" style="width: ${m.progress || 100}%"></div>
                    </div>
                </div>
...
window.fireMacro = async (name, param, isLFO = false) => {
    ...
    if (bar) {
        ...
        const duration = isLFO ? 4000 : 3500;

/* ui.js - FINAL VERSION (April 2026) — width animation + real macro timing + clean moderate layout + solid bar */
...
<div id="card-${name}" class="card bg-[#1E1E1E] border border-zinc-700 p-6 rounded-3xl">
    ...
    <!-- PROGRESS BAR — solid color, width-based, reliable -->
...
function renderCards() {
  console.log("🔄 renderCards() — moderate clean layout");
